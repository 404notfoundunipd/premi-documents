...
\begin{figure}[h!]
		\centering
		\includegraphics[scale=.35]{img/attivita/ListaPresentazioni.jpg}
...
\begin{figure}[h!]
		\centering
		\includegraphics[scale=.5]{img/attivita/Creazione_presentazione.jpg}
...
\begin{figure}[h!]
		\centering
		\includegraphics[scale=.5]{img/attivita/Modifica_titolo_e_descrizione_presentazione.jpg}
...
\begin{figure}[h!]
		\centering
		\includegraphics[scale=.5]{img/attivita/Pubblica_presentazione.jpg}
...
\begin{figure}[h!]
		\centering
		\includegraphics[scale=.4]{img/attivita/Editor_frame.jpg}
...
\begin{figure}[h!]
		\centering
		\includegraphics[scale=.5]{img/attivita/Modifica_percorso.jpg}
...
\begin{figure}[h!]
		\centering
		\includegraphics[scale=.5]{img/attivita/Aggiungi_frame_al_percorso.jpg}
