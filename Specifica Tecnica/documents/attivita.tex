...
L'utente può procedere alla creazione di un novo frame oppure selezionarne uno esistente. Una volta selezionato un frame questo viene visualizzato nell'editor e a questo punto può scegliere se eliminarlo o modificarlo.
