...
\begin{itemize}
  ...
  \item \textbf{Relazioni con altri componenti:} è il controller dedicato di  \code{Premi.Editor.TextView}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Relazioni con altri componenti:} è il controller dedicato di  \code{Premi.Editor.ShapeView}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Relazioni con altri componenti:} è il controller dedicato di  \code{Premi.Editor.ImageView}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Relazioni con altri componenti:} è il controller dedicato di  \code{Premi.Editor.StyleView}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Relazioni con altri componenti:} è il controller dedicato di  \code{Premi.Editor.FrameListView} 
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Relazioni con altri componenti:} è il controller dedicato di  \code{Premi.Editor.FrameEditor.FrameEditor.View} 
\end{itemize}
\subsubsection{Premi.}
\begin{itemize}
  \item \textbf{Nome:}
