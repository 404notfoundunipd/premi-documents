...
\begin{longtable}{|p{1cm}|p{6cm}|p{3.5cm}|p{1.8cm}|p{1.5cm}|}
	    ...
	    \hline
 	    ...
 	    \hline
  	    TU3 & Premi.Editor.graphicObject  & desc & getJSON() & \teststatus
	    \hline
	    TU4 & Premi.Editor.graphicObject  & desc & resize() & \teststatus
	    \hline
	    TU5 & Premi.Editor.graphicObject  & desc & drag() & \teststatus
	    %Image
		\hline
		TU6 &  Premi.Editor.Image  & descrizione & initByDefault() & \teststatus
		\hline
		TU7 &  Premi.Editor.Image  & descrizione & initByJSON() & \teststatus
	    %Shape
		\hline
		TU8 &  Premi.Editor.Shape  & descrizione & initByDefault() & \teststatus
   		\hline
   		TU9 &  Premi.Editor.Shape  & descrizione & initByJSON() & \teststatus
   		%Text
   		\hline
   		TU10 &  Premi.Editor.Text  & descrizione & initByDefault() & \teststatus
   		\hline
   		TU11 &  Premi.Editor.Text & descrizione & initByJSON() & \teststatus
		%Frame
   		\hline
   		TU12 &  Premi.Editor.Frame & descrizione & initByDefault() & \teststatus
   		\hline
   		TU13 &  Premi.Editor.Frame & descrizione & initByJSON() & \teststatus
   		\hline
   		TU14 &  Premi.Editor.Frame & descrizione & selectGO() deselectGO() & \teststatus
   		\hline
   		TU15 &  Premi.Editor.Frame & descrizione & addGo() & \teststatus
   		\hline
   		TU16 &  Premi.Editor.Frame & descrizione & removeSelectedGO() & \teststatus   		
   		\hline
   		TU17 &  Premi.Editor.Frame & descrizione & resizeGO() & \teststatus   		
   		\hline
   		TU18 &  Premi.Editor.Frame & descrizione & dragGO() & \teststatus
	    %Infographic
	    \hline
   		TU19 &  Premi.Editor.Infographic & descrizione & initByDefault() & \teststatus
   		\hline
   		TU20 &  Premi.Editor.Infographic & descrizione & initByJSON() & \teststatus
   		\hline
   		TU21 &  Premi.Editor.Infographic & descrizione & selectGO() deselectGO() & \teststatus
   		\hline
   		TU22 &  Premi.Editor.Infographic & descrizione & addGo() & \teststatus
   		\hline
   		TU23 &  Premi.Editor.Infographic & descrizione & removeSelectedGO() & \teststatus   		
   		\hline
   		TU24 &  Premi.Editor.Infographic & descrizione & resizeGO() & \teststatus   		
   		\hline
   		TU25 &  Premi.Editor.Infographic & descrizione & dragGO() & \teststatus
	    ...
	    \hline
   		TU28 &  Premi.Editor.InfographicEditorController & desc & changeImage() & \teststatus
   		\hline
   		TU29 &  Premi.Editor.InfographicEditorController & desc & saveInfographic() & \teststatus
   		%Trail
   		\hline
   		TU30 &  Premi.Trail & desc & nextSlide() prevSlide() & \teststatus
   		\hline
   		TU31 &  Premi.Trail & desc & enterInCheckPoint() returnToCheckPoint() & \teststatus
   		\hline
   		TU32 &  Premi.Trail & desc & goToSlide() returnToCheckPoint() & \teststatus
   		\hline
  		TU33 &  Premi.Trail & desc & insertSlideAfterCurrent() insertSlideBeforeCurrent() & \teststatus
  		\hline
  		TU34 &  Premi.Trail & desc & removeCurrentSlide() & \teststatus
   		%UserManager
   		\hline
		TU35 &  Premi.UserManager() & desc & signUp() & \teststatus
   		\hline
   		TU36 &  Premi.UserManager() & desc & signIn() & \teststatus
   		\hline
   		TU37 &  Premi.UserManager() & desc & signOut() & \teststatus
   		\hline
  		TU38 &  Premi.UserManager() & desc & changePassword() & \teststatus
