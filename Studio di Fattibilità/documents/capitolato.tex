...
Nessun membro del gruppo possiede conoscenze approfondite riguardanti HTML5$_G$ e solo pochi membri hanno usato precedentemente AngularJs e Node.js/Meteor. Sebbene il capitolato presenti in maniera chiara le caratteristiche e i requisiti minimi richiesti, il gruppo ritiene che ci siano alcune caratteristiche/condizioni non esplicite e sono inoltre presenti molti requisiti opzionali. La presenza di altri software simili molto affermati nel mercato rappresenta poi un potenziale ostacolo da superare.