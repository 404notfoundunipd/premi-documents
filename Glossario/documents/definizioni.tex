...
\begin{longtable}{p{5cm} p{0.6\columnwidth}}
	...
	\textbf{AngularJS} & è un framework open-source mantenuto da Google e da una comunità di sviluppatori e corporazioni, il cui scopo è quello di facilitare lo sviluppo di applicazioni web sempre più simili a quelle desktop.
	...
	\textbf{Best Practice} &, miglior pratica o buona prassi, indica le esperienze più significative, o comunque quelle che hanno permesso di ottenere migliori risultati, in uno specifico contesto.
...
dal browser.	
	...
	\textbf{Lightning} & è un plugin utile per sincronizzare il calendario della google.
...
Come Firefox, Thunderbird è un software libero, utilizzabile liberamente da chiunque lo desideri.
	...
	\textbf{Package} & è un meccanismo per organizzare classi in gruppi logici, principalmente (ma non solo) per definire namespace distinti per diversi contesti e per riunire classi(o entità analoghe, quali interfacce ed enumerazioni) logicamente correlate.
	...
	\textbf{Pull request} & è il meccanismo utilizzato nel software Git per avvisare i contributori di un repository delle modifiche che si vogliono apportare ai file in esso contenuti.
...
In inglese questi sistemi vengono anche indicati con i termini: issue tracking system (ITS), trouble ticket system, support ticket, request management o incident ticket system.
	...
	\textbf{Top-Down} &, modello o progettazione, è una strategia di elaborazione dell'informazione, utilizzata per analizzare situazioni problematiche e costruire ipotesi adeguate alla loro soluzione. Nel modello top-down si formula inizialmente una visione generale del sistema e successivamente si analizza ogni sua parte, aggiungendo maggiori dettagli alla progettazione. Ogni nuova parte così ottenuta può quindi essere nuovamente rifinita, specificando ulteriori dettagli, finché la specifica completa è sufficientemente dettagliata da validare il modello.
