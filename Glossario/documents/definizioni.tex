...
\medskip
\begin{addmargin}[5em]{1em}	
è un sistema che permette a più sviluppatori di lavorare ad un progetto senza dover necessariamente essere connessi ad una rete. Anziché lavorare in un'unica repository comune, ogni sviluppatore
...
\medskip
\begin{addmargin}[5em]{1em}	
Git è un sistema software di controllo di versione distribuito, creato da Linus Torvalds nel 2005 e 
...
\medskip
\begin{addmargin}[5em]{1em}	
All'interno di una repository, significa riunire un branch di copia con il branch originale, 
...
\medskip
\begin{addmargin}[5em]{1em}
una pull request o ``richiesta di pull'' avviene dopo aver eseguito una push e serve per avvisare i mantenitori.	
\end{addmargin}	
