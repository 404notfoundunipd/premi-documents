...
\medskip
\begin{addmargin}[5em]{1em}	
	E' un framework di presentazione basato sulla potenza delle trasformazioni e delle transizioni del CSS3 nei moderni browser e ispirato all'idea che sta sotto prezi.com.
\end{addmargin}	
...
\medskip
\begin{addmargin}[5em]{1em}	
è un plugin utile per sincronizzare il calendario di google.
\end{addmargin}
