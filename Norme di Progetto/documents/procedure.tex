...
I rischi, il loro grado di pericolosità, la loro probabilità di avverarsi e le contromisure da adottare per prevenirli o correggerli vengono descritti in dettaglio nel \PdP .
...
In seguito alla scelta del capitolato da parte del gruppo è necessario che gli \textit{Analisti} redigano uno \SF . Questo documento dovrà focalizzarsi su:
\begin{itemize}
...
Il documento che raccoglie le informazioni ricavate durante la progettazione architetturale è la \ST , e deve essere composto dalle seguenti sezioni:
\begin{itemize}
...
È compito dei \textit{Progettisti} utilizzare quanto scritto nella \ST{} per produrre la \DdP{} dove viene descritta la progettazione di dettaglio del sistema. Lo scopo di questo documento è quello di definire dettagliatamente ogni singola unità di cui è composto il sistema in modo da semplificare l’attività di codifica e allo stesso tempo di non fornire alcun grado di libertà al \ruoloProgrammatore.
