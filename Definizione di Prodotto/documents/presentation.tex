...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.75]{img/diacla/Trail.png}
...
\item[Attributi] \hfill
	\begin{description}
		...
		\item[\textbf{- path : Array			}] \hfill
			...
			Array che contiene i frame su cui si sta lavorando in ordine di aggiunta. 
	\end{description}
...
\item[Metodi] \hfill
	...
	% -- inizio metodo -- %
	\begin{description}
		\item[\textbf{\color{blue}- removeChkPoint(idSlide : String) : Trail			}] \hfill
...
% -- inizio metodo -- %
	\begin{description}
		\item[\textbf{\color{blue}- switchSlides(pos1 : int, pos2 : int, lvl : int) : void			}] \hfill
			permette lo spostamento di una slide da una posizione all'altra.
		...
		\begin{description}
			...
			\item[Argomenti] \hfill
				\begin{itemize}
					...
					\item \textbf{pos1 : int		} \hfill
					posizione di dove si trova la slide da spostare
					\item \textbf{pos2 : int		} \hfill
					posizione di dove va inserita la slide da spostare
					\item \textbf{lvl : int		} \hfill
					livello di trasparenza della slide da spostare
	...
	% -- inizio metodo -- %
	\begin{description}
		\item[\textbf{\color{blue}+ goToFirst() : boolean			}] \hfill
			Sposta la visualizzazione sulla prima slide del percorso
	...
	% -- inizio metodo -- %
	\begin{description}
		\item[\textbf{\color{blue}+ getCheckId(idSlide : String) : String			}] \hfill
			Restituisce l'id della posizione all'interno del percorso di specializzazione in cui si trova la slide data in input.  
	...
	% -- fine metodo -- %
		...
		\begin{description}
		\item[\textbf{\color{blue}+ getSpecPath(idSlide : String) : String			}] \hfill
			Restituisce le slide precedenti che formano il percorso per arrivare alla slide data in input nel percorso di specializzazione  
	...
	% -- inizio metodo -- %
	\begin{description}
		\item[\textbf{\color{blue}+ insertSlideInPath(idSlide : String, idCheck : String) : trail			}] \hfill
			Inserisce la slide ricevuta nella posizione successiva a quella attualmente selezionata. Restituisce un riferimento di trail
		...
		\begin{description}
			...
			\item[Argomenti] \hfill
				\begin{itemize}
					...
					Rappresenta il codice di dove deve essere inserita la slide nel percorso di specializzazione
	...
	% -- inizio metodo -- %
	\begin{description}
		\item[\textbf{\color{blue}+ removeChkPoint() : void			}] \hfill
	...
	% -- inizio metodo -- %
	\begin{description}
		\item[\textbf{\color{blue}+ switchDxSlide(idSlide : String) : trail			}] \hfill
			sposta la slide di una posizione a destra del percorso di specializzazione. Restituisce un riferimento di trail
	...
	% -- fine metodo -- %
		...
		% -- inizio metodo -- %
	\begin{description}
		\item[\textbf{\color{blue}+ switchSxSlide(idSlide : String) : trail			}] \hfill
			sposta la slide di una posizione a sinistra del percorso di specializzazione. Restituisce un riferimento di trail.
