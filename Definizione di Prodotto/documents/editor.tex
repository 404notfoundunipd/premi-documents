...
\item[Attributi] \hfill \\
	...
	\begin{itemize}
		...
		\item \textit{fill:} definisce ; %da chiarire
        \item \textit{stroke:} definisce ; %da chiarire
        \item \textit{strokeWidth:} definisce ; %da chiarire
		\item \textit{type:} identifica il tipo di oggetto.		
	\end{itemize}
	\end{description}
...
\item[Attributi] \hfill \\
	...
	\begin{itemize}
		...
		\item \textit{weight:} definisce come visualizzare il testo (es Bold, normal); %da chiarire
        \item \textit{fontFamily:} definisce il font del testo; %da chiarire
        \item \textit{textDecoration:} definisce particolari decorazioni da attribuire al testo; %da chiarire
        \item \textit{sizeFontText:} definisce la grandezza del testo; %da chiarire
		\item \textit{type:} identifica il tipo di oggetto.		
	\end{itemize}
	\end{description}
